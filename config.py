...
For Current Employment (i.e. employment where words like "present" or "till date" or "current" or "today" is mentioned as end date), do not give any EndDate.
Do not give any dates out of assumption or hallucination - give dates only if mentioned in resume.
If skills are not explicitly mentioned then try to get some relevant skills from employment experience.
